...
Minimal Ottrix agent HTTP server using `@ottrix/hono`. Same code runs on Cloudflare Workers, Bun, and Deno — swap the server bootstrap.
...
```bash
cd examples/http-agents/hono-agent
