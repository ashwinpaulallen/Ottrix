...
Also exported from root `ottrix` for advanced custom wiring.
...
`ottrix/providers` — full barrel  
`ottrix/providers/anthropic` · `/openai` · `/ollama` · `/base` · `/registry` · `/errors` — individual modules
